...
class AppThemeLight extends AppTheme {
  ...
  ThemeData get theme {
    return ThemeData(
        ...
        textSelectionTheme: TextSelectionThemeData(cursorColor: ColorTheme.PRIMARY_RED),
        ...
        appBarTheme: AppBarTheme(
          ...
          // brightness has been deprecated; use systemOverlayStyle or remove
          // Example: systemOverlayStyle: SystemUiOverlayStyle.light
        ),
  ...
  ColorScheme colorScheme() {
    return ColorScheme.light(
        ...
        secondaryContainer: ColorTheme.GREY_HINT,
