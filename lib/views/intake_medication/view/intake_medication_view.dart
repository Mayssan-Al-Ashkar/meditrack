...
class IntakeMedicationView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BaseView<IntakeMedicationViewModel>(
        onModelReady: (IntakeMedicationViewModel model) {
            ...
            ElevatedButton(
                onPressed: () async {
                    bool hasReminderSaved = await viewmodel
                      .saveMedicationIntakeButtonOnPress(medication ?? InventoryModel(
                        barcode: "barcode",
                        name: "name",
        ...
        child: Row(
          ...
          children: [
            ...
            TextButton.icon(
                ...
                label: Text(DateFormat.yMd().format(viewmodel.date)),
                onPressed: () {
        ...
        child: Row(
          ...
          children: [
            ...
            TextButton.icon(
                ...
                label: viewmodel.selectedTime.isNotEmpty
